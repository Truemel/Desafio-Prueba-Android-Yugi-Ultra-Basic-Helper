...
@Database(entities = [YugiSetTablePojo::class, YugiCardTablePojo::class, YugiFavouriteTablePojo::class, YugiCardDataTablePojo::class], version = 0, exportSchema = false)
