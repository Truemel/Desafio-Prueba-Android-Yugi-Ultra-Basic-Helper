...
@Database(entities = [YugiSetTablePojo::class, YugiCardTablePojo::class, YugiFavouriteTablePojo::class, YugiCardDataTablePojo::class], version = 1, exportSchema = false)
